    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4 font-sans">
      <div className="bg-white p-8 rounded-lg shadow-2xl max-w-4xl w-full">
        ...
        <form onSubmit={handleSubmit} className="mb-8">
          ...
          <button type="submit" disabled={loading}>{loading ? 'Diagnosing...' : 'Get Expert Diagnosis'}</button>
        ...
        {result && (
          <div className="space-y-6">
            ...
            <button onClick={handleDownloadPDF}>Download Enhanced PDF Report</button>
          </div>
        )}
      </div>
    </div>
